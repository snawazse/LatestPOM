...
public class LoginPage {
	...
	private By logo=By.xpath("//img[@alt='rego logo']");
	private By appLink=By.xpath("//button[normalize-space()='Download App']");
	...
	@Step("checking logo is displayed or not.....")
	...
	public int getLabelCount(){
		return eleutil.getElements(label).size();
	}

	public String getAllLabelsName(){
		 eleutil.printAllElementsText(label, Constants.DEFAULT_TIME_OUT);
		 return null;
	}
